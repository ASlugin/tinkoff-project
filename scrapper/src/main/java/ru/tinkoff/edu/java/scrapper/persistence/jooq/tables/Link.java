 ...
 */
package ru.tinkoff.edu.java.scrapper.persistence.jooq.tables;
...
import ru.tinkoff.edu.java.scrapper.persistence.jooq.DefaultSchema;
import ru.tinkoff.edu.java.scrapper.persistence.jooq.Keys;
import ru.tinkoff.edu.java.scrapper.persistence.jooq.tables.records.LinkRecord;
...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("UPDATED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field("LOCALTIMESTAMP", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>LINK.CHECKED_AT</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> CHECKED_AT = createField(DSL.name("CHECKED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field("LOCALTIMESTAMP", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
