 ...
 */
package ru.tinkoff.edu.java.scrapper.persistence.jooq.tables.records;
...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, OffsetDateTime, OffsetDateTime> {
    ...
    public LinkRecord(@NotNull Long id, @NotNull String url, @Nullable OffsetDateTime updatedAt, @Nullable OffsetDateTime checkedAt) {
        super(Link.LINK);
     ...
     * Create a detached, initialised LinkRecord
     */
    public LinkRecord(ru.tinkoff.edu.java.scrapper.persistence.jooq.tables.pojos.Link value) {
        super(Link.LINK);
